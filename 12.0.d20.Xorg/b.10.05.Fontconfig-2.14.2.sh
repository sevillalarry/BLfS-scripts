...
install -m644 fc-*/*.1         /usr/share/man/man1
install -m644 doc/*.3          /usr/share/man/man3
install -m644 doc/fonts-conf.5 /usr/share/man/man5
install -m644 doc/fontconfig-devel/* \
                               /usr/share/doc/fontconfig-2.14.2/fontconfig-devel
install -m644 doc/*.{pdf,sgml,txt,html} \
