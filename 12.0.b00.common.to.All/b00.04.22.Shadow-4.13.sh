...
if [ -f /etc/login.access ]; then mv /etc/login.access{,.NOUSE}; fi
if [ -f /etc/limits ]; then mv /etc/limits{,.NOUSE}; fi

echo "read: https://www.linuxfromscratch.org/blfs/view/12.0/postlfs/shadow.html"
